...
export const UPWORK_PROFILE_RULES = [
  ...
  "- PLAIN TEXT ONLY. No markdown. Forbidden characters/patterns: **, *, # headings, `backticks`, [links](url).",
  "- Use short paragraphs separated by blank lines. Prefer prose over lists. If you must list, use '1.' '2.' or lines starting with '- ' (hyphen + space) — NEVER asterisks.",
  "- Structure:",
  ...
  "  4) Proof — ONLY clients/people/companies/metrics that appear in the scraped 'Named clients' / work history / overview. If none, write proof without naming anyone.",
  ...
  "- Prefer skills already on the profile or clearly implied by tools in the overview — do not invent unrelated stacks.",
  "",
  "ACTION PLAN:",
